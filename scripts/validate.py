...
#     """
#     Handles logging and quarantining of a file with a single function.
#     Ensures logs are written in one line and the file is quarantined properly.
#     """
#     log_message = f"{file_path} quarantined - Validation failed: {error_message}"
#     quarantine_file(file_path, log_message)
#     log_error(file_path, log_message)
#     print(log_message)
